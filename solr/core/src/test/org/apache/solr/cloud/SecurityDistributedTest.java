  ...
  public void test() throws Exception {
    ...
    doAndAssertSolrExeption(401, new Callable<Object>() {
      ...
      public Object call() throws Exception {
        ...
        controlClient.query(params, AuthCredentials.createBasicAuthCredentials(SEARCH_USERNAME, SEARCH_PASSWORD + "wrong"));
        return null;
      }
    });
    ...
    doAndAssertSolrExeption(403, new Callable<Object>() {
      ...
      public Object call() throws Exception {
        ...
        params.add("q", "*:*");
        params.set("distrib", "false");
        controlClient.query(params, UPDATE_CREDENTIALS);
        return null;
      }
    });
    ...
    try {
      doAndAssertSolrExeption(ErrorCode.PRECONDITION_FAILED.code, 
          ...
          new Callable<Object>() {
            @Override
            public Object call() throws Exception {
              createCollection("security_new_collection2", getShardCount(), 1, 1);
              return null;
            }
          });
    } finally {
    ...
    try {
      doAndAssertSolrExeption(ErrorCode.PRECONDITION_FAILED.code, 
          ...
          new Callable<Object>() {
            @Override
            public Object call() throws Exception {
              createCollection("security_new_collection3", getShardCount(), 1, 1);
              return null;
            }
          });
    } finally {
