...
//    assertJQ("/config/managed", "/managedResources==[]");
    ...
    assertJQ(newEndpoint + "/Test", 404, "Test not found in /schema/analysis/protwords/english");
    ...
    assertJPut(newEndpoint, json("{ 'initArgs':{ 'ignoreCase':false } }"), 400, "Changing a managed word set's ignoreCase arg from true to false is not permitted.");
